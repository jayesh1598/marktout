...
export const Products: React.FC = () => {
  ...
  const [inventorySettings] = useState<InventorySettings>(defaultInventorySettings);
  const [marketingIntegrations] = useState<IntegrationItem[]>([
    {
  ...
  const [paymentIntegrations] = useState<IntegrationItem[]>([
    {
      id: 'phonepe',
      name: 'PhonePe',
  ...
  const [deliveryIntegrations] = useState<IntegrationItem[]>([
    {
      id: 'shiprocket',
      name: 'Shiprocket',
